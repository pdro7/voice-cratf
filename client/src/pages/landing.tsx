      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-4 h-16">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-lg text-foreground" data-testid="text-logo">LOKEL<span className="text-primary">AI</span></span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold text-lg text-foreground">LOKEL<span className="text-primary">AI</span></span>
            </div>
